...
#     , with a transect for the plane of azimuth=120 deg, output in a PNG file
python smartg_analyze.py -Q -s gallery/example3.png  -p 2 -r 0.05 -t 120 data/out_2_560.000000_thv-40.000000-sp.hdf data/out_2_560.000000_thv-40.000000-pp.hdf
#
...
python smartg_analyze.py -Q -s gallery/example4.png -r 0.2 -p 100 -o LAMBDA,400,700 -l 0,60 -t 120 list.txt
#
