...
echo
./SMART-G-pp input/PP-Rayleigh-Sol_noir-1e9_photons.inp | tee resultat/PP-Rayleigh-Sol_noir-1e9_photons.out
...
echo
./SMART-G-pp input/PP-Rayleigh-Aerosol-Sol_noir-1e9_photons.inp | tee resultat/PP-Rayleigh-Aerosol-Sol_noir-1e9_photons.out
...
echo
./SMART-G-pp input/PP-Rayleigh-Aerosol-Glitter-1e9_photons.inp | tee resultat/PP-Rayleigh-Aerosol-Glitter-1e9_photons.out
...
echo
./SMART-G-sp input/SP-Rayleigh-Sol_noir-1e9_photons.inp | tee resultat/SP-Rayleigh-Sol_noir-1e9_photons.out
...
echo
./SMART-G-sp input/SP-Rayleigh-Aerosol-Sol_noir-1e10_photons.inp | tee resultat/SP-Rayleigh-Aerosol-Sol_noir-1e10_photons.out
...
echo
./SMART-G-sp input/SP-Rayleigh-Aerosol-Glitter-1e9_photons.inp | tee resultat/SP-Rayleigh-Aerosol-Glitter-1e9_photons.out
