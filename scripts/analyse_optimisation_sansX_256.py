...
pathDossierGraphes = "out_scripts/analyse_optimisation_sansX_256"
pathFichierParam = "tmp/opt_sansX_256_param.txt"
# Si le fichier suivant existe deja on demande s'il faut poursuivre avec ou le supprimer
pathFichierSauv = "tmp/opt_sansX_256_sauv"
...
ylabel("Temps (sec)")
grid(True)
savefig(pathDossierGraphes+"/variations_XGRID_zoom.png", dpi=(140))
figure()
