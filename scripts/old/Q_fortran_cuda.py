...
path_dossier_sortie = "/home/florent/MCCuda/validation/"+type_simu+"/graph_"+date_simu+"/Q/Q_FORTRAN_CUDA_" + nom_cuda
...
# Sauvegarde de la grandeur désirée, ici Q
...
type_donnees = 'Q'	# Nom à insérer dans la légende
