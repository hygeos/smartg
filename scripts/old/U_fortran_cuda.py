...
path_dossier_sortie = "/home/florent/MCCuda/validation/"+type_simu+"/graph_"+date_simu+"/U/U_FORTRAN_CUDA_" + nom_cuda
...
# Sauvegarde de la grandeur désirée, ici U
...
# U n'est pas symétrique, on le représente donc uniquement sur [0,PI]
...
type_donnees = 'U'	# Nom à insérer dans la légende
