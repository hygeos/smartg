...
path_dossier_sortie = "/home/florent/MCCuda/validation/"+type_simu+"/graph_"+date_simu+"/I/I_FORTRAN_CUDA_" + nom_cuda
...
if os.path.exists(path_cuda):
	...
	name = "Valeurs de la reflectance (I)"
...
# Sauvegarde de la grandeur désirée, ici I
...
type_donnees = 'Reflectance'	# Nom à insérer dans la légende
