...
python smartg_analyze.py -Q -s gallery/example1.png data/out_2_560.000000_thv-40.000000-sp.hdf
#
...
python smartg_analyze.py -Q -s gallery/example2.png  -p 100 -r 0.3 -t 120 data/out_2_560.000000_thv-40.000000-sp.hdf
#
# Example 3 Differences
# Absolute Difference of two files (here spherical - plane parallel), polar plot (theta_s,phi) of I and Polarization Ratio only (diff) with scale set to 2%, reflectance (diff) scale set to 0.05, 
#     , with a transect for the plane of azimuth=120 deg, output in a PNG file
...
python smartg_analyze.py -Q -s gallery/example4.png -r 0.2 -p 100 -o LAMBDA,400,700 -l 0,60 -t 120 data/list.txt
#
